                ...
                with tf.device(gpu1):
                    for element in lst[1:]:
                        if element[0]=='conv':
                            ...
                            weight=tf.get_variable("wc_{}".format(self.layer),[element[1][0],element[1][1],size[3],element[1][2]],filter_dtype)
                            bias=tf.get_variable("wb_{}".format(self.layer),element[1][2],filter_dtype)
                            weight=tf.nn.conv2d(self.input,weight,strides=[1,element[2][0],element[2][1],1],padding=padding)
                ...
                with tf.device(gpu1):
                    for element in lst [start_point:]:     ##############
                        if element[0]=='conv':
                            ...
                            weight1=tf.get_variable("wc1_{}".format(self.layer1),[element[1][0],element[1][1],size1[3],element[1][2]],filter_dtype)
                            bias1=tf.get_variable("wb1_{}".format(self.layer1),element[1][2],filter_dtype)
                            weight1=tf.nn.conv2d(self.input1,weight1,strides=[1,element[2][0],element[2][1],1],padding=padding)
                            ...
                            tf.add_to_collection('checkpoints', self.input1)
                            print(element)
                            print(self.input1)
                ...
                with tf.device(gpu1):
                    for element in lst [start_point:]:
                        if element[0]=='conv':
                            ...
                            weight2=tf.get_variable("wc2_{}".format(self.layer2),[element[1][0],element[1][1],size2[3],element[1][2]],filter_dtype)
                            bias2=tf.get_variable("wb2_{}".format(self.layer2),element[1][2],filter_dtype)
                            weight2=tf.nn.conv2d(self.input2,weight2,strides=[1,element[2][0],element[2][1],1],padding=padding)
                            ...
                            tf.add_to_collection('checkpoints', self.input2)
                            print(element)
                            print(self.input2)
