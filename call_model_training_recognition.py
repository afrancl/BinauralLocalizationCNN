from tf_record_CNN_spherical_gradcheckpoint_recognition import tf_record_CNN_spherical
import os
import glob
import numpy as np
...
newpath='/om2/user/francl/branchpoint_search/recognition/arch_number_'+str(arch_ID)
