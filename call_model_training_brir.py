from tf_record_CNN_spherical_gradcheckpoint_brir import tf_record_CNN_spherical
import os
import glob
import numpy as np
...
bkgd_train_path_pattern = '/om/scratch/Mon/francl/bkgdRecords_pinknoise_vary_env_brirs/train*.tfrecords'
train_path_pattern = '/nobackup/scratch/Mon/francl/stimRecords_brir_conv/train*.tfrecords'

#arch_ID=int(sys.argv[1])
arch_ID=38

newpath='/om2/user/francl/localization_runs/brir_confroom/arch_number_'+str(arch_ID)
