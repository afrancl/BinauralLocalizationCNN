...
model_path=/om2/user/francl/new_task_archs/new_task_archs_logspaced_tones_anechoic_no_background_noise_80dBSNR_training
...
train_path_pattern=/nobackup/scratch/Sat/francl/toneRecords_logspaced_jitteredPhase_convolved_anechoic_oldHRIRdist140_no_hanning_stackedCH_upsampled/train*.tfrecords
